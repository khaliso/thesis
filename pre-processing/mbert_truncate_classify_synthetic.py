...
# Input CSV file
input_file = "my_datasets/HatEval/synthetic/new_HatEval_hateful_synthetic_data.csv"
output_file = "my_datasets/HatEval/synthetic/trunc_mbert_HatEval_hateful_synthetic_data.csv"
...
model = "models/GermEval_mbert_5fold"  # Pre-trained model
pl = pipeline('text-classification', model=model, tokenizer=tokenizer)

# Load and classify the dataset
dataset_path = 'my_datasets/HatEval/synthetic/trunc_mbert_HatEval_hateful_synthetic_data.csv'  # hate and non-hate synthetic dataset here
output_file = 'my_datasets/HatEval/synthetic/_classified_trunc_mbert_HatEval_hateful_synthetic_data.csv'  # Specify the path for the output CSV file
