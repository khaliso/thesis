...
vals_ds_bin, trains_ds_bin = load_and_tokenize_training_set("my_datasets/SMOTE-PCL.csv")

wandb.init(project="PCL_hatebert_SMOTE")
...
for i in range(4,5):
    ...
    metrics_df.to_csv("Logs/PCL_hatebert_SMOTE-metrics.csv")

trainer.save_model("models/PCL_hatebert_SMOTE")