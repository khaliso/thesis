...
vals_ds_bin, trains_ds_bin = load_and_tokenize_training_set("my_datasets/us_Founta_HatEval_SF.csv")
synth_ds_bin = load_and_tokenize_synthetic_set("my_datasets/us_synth_Founta_HatEval_SF.csv")

wandb.init(project="Bert-composite-TL-us_Founta_HatEval_SF")  # Initialize W&B before the loop
...
for i in range(4,5):
    ...
    metrics_df.to_csv("Logs/Bert-composite-TL-us_Founta_HatEval_SF-metrics.csv")

trainer.save_model("models/Bert-composite-TL-us_Founta_HatEval_SF")